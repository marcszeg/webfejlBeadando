            ...
            <div>
                ...
                <div className="row" style={{width:"800px", marginLeft:"150px"}}>
                    <table className="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th onClick={this.sortData} className="text-center align-middle" style={{width:"300px"}}>Title<div className={this.state.sortToggle ? "arrow arrow-up" : "arrow arrow-down"}></div></th>
                                <th>Artist</th>
                                <th>Release date</th>
                                <th></th>
                            </tr>
                        ...
                        <tbody>
                            {albums.length === 0 ?
                                ...
                                albums.map(
                                    album =>
                                        <tr key = {album.id}>
                                            <td className="text-center align-middle" style={{fontSize:"18px"}}>{album.title}</td>
                                            <td className="text-left align-middle" style={{fontSize:"18px"}}>{album.artist}</td>
                                            <td className="text-left align-middle" style={{fontSize:"18px"}}>{album.release}</td>
